...
export class Interpreter {
    ...
    * @returns {Interpreter}
    */
    static new(program, input, mem_size) {
        ...
        var ret = wasm.interpreter_new(ptr0, len0, ptr1, len1, mem_size);
        return Interpreter.__wrap(ret);
    }
    /**
    * @param {number} inst_per_cycle
    * @returns {boolean}
    */
    tick(inst_per_cycle) {
        var ret = wasm.interpreter_tick(this.ptr, inst_per_cycle);
        return ret !== 0;
    }
    /**
    * @returns {string}
    */
    render() {
        try {
            wasm.interpreter_render(8, this.ptr);
